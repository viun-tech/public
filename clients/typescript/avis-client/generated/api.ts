...
export interface ConfigurationStatistics {
     ...
     *
     * @type {number}
     * @memberof ConfigurationStatistics
     */
     ...
     * @memberof ConfigurationStatistics
     */
    'inspections_marked_for_validation': number;
}
/**
 *
 * @export
 * @interface ConfigurationStatisticsRequest
 */
export interface ConfigurationStatisticsRequest {
    /**
     *
     * @type {number}
     * @memberof ConfigurationStatisticsRequest
     */
    'configuration': number;
    /**
     *
 ...
 *
 * @export
 * @interface PaginatedConfigurationStatisticsList
 */
export interface PaginatedConfigurationStatisticsList {
    /**
     *
     * @type {number}
     * @memberof PaginatedConfigurationStatisticsList
     */
    'count': number;
    /**
     *
    ...
    /**
     *
     * @type {Array<ConfigurationStatistics>}
     * @memberof PaginatedConfigurationStatisticsList
     */
    'results': Array<ConfigurationStatistics>;
}
/**
 *
 * @export
...
export const StatisticsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * A mixin that allows reading entities (listing and retrieving by id).
         * @param {ConfigurationStatisticsRequest} configurationStatisticsRequest
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        statisticsConfigurationCreate: async (configurationStatisticsRequest: ConfigurationStatisticsRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'configurationStatisticsRequest' is not null or undefined
            assertParamExists('statisticsConfigurationCreate', 'configurationStatisticsRequest', configurationStatisticsRequest)
            const localVarPath = `/api/statistics/configuration/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(configurationStatisticsRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        statisticsConfigurationDestroy: async (id: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('statisticsConfigurationDestroy', 'id', id)
            const localVarPath = `/api/statistics/configuration/{id}/`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        statisticsConfigurationList: async (id?: Array<number>, ordering?: string, page?: number, pageSize?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/statistics/configuration/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        statisticsConfigurationRetrieve: async (id: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('statisticsConfigurationRetrieve', 'id', id)
            const localVarPath = `/api/statistics/configuration/{id}/`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        statisticsConfigurationUpdate: async (id: number, configurationStatisticsRequest: ConfigurationStatisticsRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('statisticsConfigurationUpdate', 'id', id)
            // verify required parameter 'configurationStatisticsRequest' is not null or undefined
            assertParamExists('statisticsConfigurationUpdate', 'configurationStatisticsRequest', configurationStatisticsRequest)
            const localVarPath = `/api/statistics/configuration/{id}/`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const StatisticsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async statisticsConfigurationCreate(configurationStatisticsRequest: ConfigurationStatisticsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ConfigurationStatistics>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.statisticsConfigurationCreate(configurationStatisticsRequest, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['StatisticsApi.statisticsConfigurationCreate']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * A mixin that allows reading entities (listing and retrieving by id).
         ...
         * @throws {RequiredError}
         */
        async statisticsConfigurationDestroy(id: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.statisticsConfigurationDestroy(id, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['StatisticsApi.statisticsConfigurationDestroy']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * A mixin that allows reading entities (listing and retrieving by id).
         ...
         * @throws {RequiredError}
         */
        async statisticsConfigurationList(id?: Array<number>, ordering?: string, page?: number, pageSize?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedConfigurationStatisticsList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.statisticsConfigurationList(id, ordering, page, pageSize, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['StatisticsApi.statisticsConfigurationList']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * A mixin that allows reading entities (listing and retrieving by id).
         ...
         * @throws {RequiredError}
         */
        async statisticsConfigurationRetrieve(id: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ConfigurationStatistics>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.statisticsConfigurationRetrieve(id, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['StatisticsApi.statisticsConfigurationRetrieve']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * A mixin that allows reading entities (listing and retrieving by id).
         ...
         * @throws {RequiredError}
         */
        async statisticsConfigurationUpdate(id: number, configurationStatisticsRequest: ConfigurationStatisticsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ConfigurationStatistics>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.statisticsConfigurationUpdate(id, configurationStatisticsRequest, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['StatisticsApi.statisticsConfigurationUpdate']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * A mixin that only allows retrieving entities by id.
...
export const StatisticsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        statisticsConfigurationCreate(configurationStatisticsRequest: ConfigurationStatisticsRequest, options?: any): AxiosPromise<ConfigurationStatistics> {
            return localVarFp.statisticsConfigurationCreate(configurationStatisticsRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * A mixin that allows reading entities (listing and retrieving by id).
         * @param {number} id A unique integer value identifying this configuration.
         ...
         * @throws {RequiredError}
         */
        statisticsConfigurationDestroy(id: number, options?: any): AxiosPromise<void> {
            return localVarFp.statisticsConfigurationDestroy(id, options).then((request) => request(axios, basePath));
        },
        /**
         * A mixin that allows reading entities (listing and retrieving by id).
         * @param {Array<number>} [id] Multiple values may be separated by commas.
         ...
         * @throws {RequiredError}
         */
        statisticsConfigurationList(id?: Array<number>, ordering?: string, page?: number, pageSize?: number, options?: any): AxiosPromise<PaginatedConfigurationStatisticsList> {
            return localVarFp.statisticsConfigurationList(id, ordering, page, pageSize, options).then((request) => request(axios, basePath));
        },
        /**
         * A mixin that allows reading entities (listing and retrieving by id).
         * @param {number} id A unique integer value identifying this configuration.
         ...
         * @throws {RequiredError}
         */
        statisticsConfigurationRetrieve(id: number, options?: any): AxiosPromise<ConfigurationStatistics> {
            return localVarFp.statisticsConfigurationRetrieve(id, options).then((request) => request(axios, basePath));
        },
        /**
         * A mixin that allows reading entities (listing and retrieving by id).
         * @param {number} id A unique integer value identifying this configuration.
         ...
         * @throws {RequiredError}
         */
        statisticsConfigurationUpdate(id: number, configurationStatisticsRequest: ConfigurationStatisticsRequest, options?: any): AxiosPromise<ConfigurationStatistics> {
            return localVarFp.statisticsConfigurationUpdate(id, configurationStatisticsRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * A mixin that only allows retrieving entities by id.
         * @param {InspectionImagesStatisticsRequest} inspectionImagesStatisticsRequest
...
export interface StatisticsApiInterface {
     ...
     */
    statisticsConfigurationCreate(configurationStatisticsRequest: ConfigurationStatisticsRequest, options?: RawAxiosRequestConfig): AxiosPromise<ConfigurationStatistics>;
     ...
     * @memberof StatisticsApiInterface
     */
    statisticsConfigurationDestroy(id: number, options?: RawAxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof StatisticsApiInterface
     */
    statisticsConfigurationList(id?: Array<number>, ordering?: string, page?: number, pageSize?: number, options?: RawAxiosRequestConfig): AxiosPromise<PaginatedConfigurationStatisticsList>;
     ...
     * @memberof StatisticsApiInterface
     */
    statisticsConfigurationRetrieve(id: number, options?: RawAxiosRequestConfig): AxiosPromise<ConfigurationStatistics>;
     ...
     * @memberof StatisticsApiInterface
     */
    statisticsConfigurationUpdate(id: number, configurationStatisticsRequest: ConfigurationStatisticsRequest, options?: RawAxiosRequestConfig): AxiosPromise<ConfigurationStatistics>;
...
export class StatisticsApi extends BaseAPI implements StatisticsApiInterface {
     ...
     */
    public statisticsConfigurationCreate(configurationStatisticsRequest: ConfigurationStatisticsRequest, options?: RawAxiosRequestConfig) {
        return StatisticsApiFp(this.configuration).statisticsConfigurationCreate(configurationStatisticsRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof StatisticsApi
     */
    public statisticsConfigurationDestroy(id: number, options?: RawAxiosRequestConfig) {
        return StatisticsApiFp(this.configuration).statisticsConfigurationDestroy(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof StatisticsApi
     */
    public statisticsConfigurationList(id?: Array<number>, ordering?: string, page?: number, pageSize?: number, options?: RawAxiosRequestConfig) {
        return StatisticsApiFp(this.configuration).statisticsConfigurationList(id, ordering, page, pageSize, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof StatisticsApi
     */
    public statisticsConfigurationRetrieve(id: number, options?: RawAxiosRequestConfig) {
        return StatisticsApiFp(this.configuration).statisticsConfigurationRetrieve(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof StatisticsApi
     */
    public statisticsConfigurationUpdate(id: number, configurationStatisticsRequest: ConfigurationStatisticsRequest, options?: RawAxiosRequestConfig) {
        return StatisticsApiFp(this.configuration).statisticsConfigurationUpdate(id, configurationStatisticsRequest, options).then((request) => request(this.axios, this.basePath));
    }
