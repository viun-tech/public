...
> List[ImageAttributeCategory] image_attribute_category_list(fields=fields, id=id)
...
with avis_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.image_attribute_category_list(fields=fields, id=id)
