...
class MlApi:
    ...
    def ml_inspectionresult_partial_update(
        ...
        patched_classification_result_request: Optional[
            PatchedClassificationResultRequest
        ] = None,
        _request_timeout: Union[
            None,
    ...
    def ml_model_destroy(
        ...
        id: Annotated[
            StrictInt,
            Field(description="A unique integer value identifying this ml model."),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def ml_modeltype_destroy(
        ...
        id: Annotated[
            StrictInt,
            Field(description="A unique integer value identifying this ml model type."),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
