...
class QualityCriteriaApi:
    ...
    def quality_criteria_create(
        ...
        :param quality_criteria_request: (required)
        :type quality_criteria_request: QualityCriteriaRequest
    ...
    def quality_criteria_destroy(
        ...
        :param id: A unique integer value identifying this quality criteria. (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def quality_criteria_partial_update(
        ...
        :param id: A unique integer value identifying this quality criteria. (required)
        :type id: int
        :param patched_quality_criteria_request:
        :type patched_quality_criteria_request: PatchedQualityCriteriaRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._quality_criteria_partial_update_serialize(
            id=id,
            patched_quality_criteria_request=patched_quality_criteria_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
