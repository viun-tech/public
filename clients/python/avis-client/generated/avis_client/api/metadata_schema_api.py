...
class MetadataSchemaApi:
    ...
    def metadata_schema_create(
        ...
        :param metadata_schema_request: (required)
        :type metadata_schema_request: MetadataSchemaRequest
    ...
    def metadata_schema_destroy(
        ...
        :param id: A unique integer value identifying this metadata schema. (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def metadata_schema_partial_update(
        ...
        :param id: A unique integer value identifying this metadata schema. (required)
        :type id: int
        :param patched_metadata_schema_request:
        :type patched_metadata_schema_request: PatchedMetadataSchemaRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._metadata_schema_partial_update_serialize(
            id=id,
            patched_metadata_schema_request=patched_metadata_schema_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _metadata_schema_partial_update_serialize(
        self,
        id,
        patched_metadata_schema_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
