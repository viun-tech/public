...
class PatchedBinaryClassInspectionResultTypedRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["team", "reported_by", "image", "type", "confidence", "comment", "binary_class"]
