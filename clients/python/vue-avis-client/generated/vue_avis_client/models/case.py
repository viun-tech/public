...
class Case(BaseModel):
    ...
    id: StrictInt
    team: StrictInt
    inspection_object: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "team", "inspection_object", "opened_by", "closed_by", "images", "created_at", "updated_at", "open_datetime", "close_datetime", "blueprint", "metadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if inspection_object (nullable) is None
        # and model_fields_set contains the field
        if self.inspection_object is None and "inspection_object" in self.model_fields_set:
            _dict['inspection_object'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "team": obj.get("team"),
            "inspection_object": obj.get("inspection_object"),
