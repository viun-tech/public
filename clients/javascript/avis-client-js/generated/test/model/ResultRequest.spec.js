...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Avis.ResultRequest();
  });
  ...
  describe("ResultRequest", function () {
    it("should create an instance of ResultRequest", function () {
      // uncomment below and update the code to test ResultRequest
      //var instance = new Avis.ResultRequest();
      //expect(instance).to.be.a(Avis.ResultRequest);
    });
