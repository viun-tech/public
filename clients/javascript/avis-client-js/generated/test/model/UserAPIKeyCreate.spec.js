...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Avis.UserAPIKeyCreate();
  });
  ...
  describe("UserAPIKeyCreate", function () {
    it("should create an instance of UserAPIKeyCreate", function () {
      // uncomment below and update the code to test UserAPIKeyCreate
      //var instance = new Avis.UserAPIKeyCreate();
      //expect(instance).to.be.a(Avis.UserAPIKeyCreate);
    });
