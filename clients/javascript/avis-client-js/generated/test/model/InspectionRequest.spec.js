...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new Avis.InspectionRequest();
  });
  ...
  describe("InspectionRequest", function () {
    it("should create an instance of InspectionRequest", function () {
      // uncomment below and update the code to test InspectionRequest
      //var instance = new Avis.InspectionRequest();
      //expect(instance).to.be.a(Avis.InspectionRequest);
    });
