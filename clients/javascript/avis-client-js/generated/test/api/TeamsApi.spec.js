...
(function (root, factory) {
  ...
  describe("TeamsApi", function () {
    ...
    describe("teamsDestroy", function () {
      it("should call teamsDestroy successfully", function (done) {
        //uncomment below and update the code to test teamsDestroy
        //instance.teamsDestroy(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe("teamsRetrieve", function () {
      it("should call teamsRetrieve successfully", function (done) {
        //uncomment below and update the code to test teamsRetrieve
        //instance.teamsRetrieve(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
