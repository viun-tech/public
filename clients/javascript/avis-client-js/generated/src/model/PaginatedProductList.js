 ...
 * @module model/PaginatedProductList
 * @version 0.8.0
 */
class PaginatedProductList {
    /**
     * Constructs a new <code>PaginatedProductList</code>.
     * @alias module:model/PaginatedProductList
     * @param count {Number} 
     * @param results {Array.<module:model/Product>} 
     */
    constructor(count, results) { 
        
        PaginatedProductList.initialize(this, count, results);
    }
     ...
     * @param {module:model/PaginatedProductList} obj Optional instance to populate.
     * @return {module:model/PaginatedProductList} The populated <code>PaginatedProductList</code> instance.
     */
    ...
    static validateJSON(data) {
        ...
        for (const property of PaginatedProductList.RequiredProperties) {
            if (!data[property]) {
...
PaginatedProductList.RequiredProperties = ["count", "results"];
