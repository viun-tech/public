    ...
    */
    ...
    teamsCreate(teamRequest, callback) {
      ...
      if (teamRequest === undefined || teamRequest === null) {
        throw new Error("Missing the required parameter 'teamRequest' when calling teamsCreate");
      }
    ...
    teamsDestroy(id, callback) {
      ...
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling teamsDestroy");
      }
    ...
    teamsUpdate(id, teamRequest, callback) {
      ...
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling teamsUpdate");
      }
      // verify the required parameter 'teamRequest' is set
      if (teamRequest === undefined || teamRequest === null) {
        throw new Error("Missing the required parameter 'teamRequest' when calling teamsUpdate");
      }
