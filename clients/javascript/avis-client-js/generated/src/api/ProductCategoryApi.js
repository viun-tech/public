...
export default class ProductCategoryApi {
    ...
    */
    ...
    productCategoryCreate(productCategoryRequest, callback) {
      ...
      if (productCategoryRequest === undefined || productCategoryRequest === null) {
        throw new Error("Missing the required parameter 'productCategoryRequest' when calling productCategoryCreate");
      }
    ...
    productCategoryDestroy(id, callback) {
      ...
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling productCategoryDestroy");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/api/product-category/{id}/', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    productCategoryPartialUpdate(id, opts, callback) {
      ...
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling productCategoryPartialUpdate");
      }
    ...
    productCategoryRetrieve(id, opts, callback) {
      ...
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling productCategoryRetrieve");
      }
    ...
    productCategoryUpdate(id, productCategoryRequest, callback) {
      ...
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling productCategoryUpdate");
      }
      // verify the required parameter 'productCategoryRequest' is set
      if (productCategoryRequest === undefined || productCategoryRequest === null) {
        throw new Error("Missing the required parameter 'productCategoryRequest' when calling productCategoryUpdate");
      }
