    ...
    */
    ...
    productCreate(productRequest, callback) {
      ...
      if (productRequest === undefined || productRequest === null) {
        throw new Error("Missing the required parameter 'productRequest' when calling productCreate");
      }
    ...
    productDestroy(id, callback) {
      ...
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling productDestroy");
      }
    ...
    productList(opts, callback) {
      ...
      let queryParams = {
        ...
        'identifier': this.apiClient.buildCollectionParam(opts['identifier'], 'csv'),
    ...
    productPartialUpdate(id, opts, callback) {
      ...
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling productPartialUpdate");
      }
    ...
    productRetrieve(id, opts, callback) {
      ...
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling productRetrieve");
      }
    ...
    productUpdate(id, productRequest, callback) {
      ...
      // verify the required parameter 'productRequest' is set
      if (productRequest === undefined || productRequest === null) {
        throw new Error("Missing the required parameter 'productRequest' when calling productUpdate");
      }
