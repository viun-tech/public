...
apiInstance.qualityCriteriaCreate(qualityCriteriaRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let id = 56; // Number | A unique integer value identifying this quality criteria.
let opts = {
  'patchedQualityCriteriaRequest': new ViunAvisClientJs.PatchedQualityCriteriaRequest() // PatchedQualityCriteriaRequest | 
};
...
let id = 56; // Number | A unique integer value identifying this quality criteria.
let qualityCriteriaRequest = new ViunAvisClientJs.QualityCriteriaRequest(); // QualityCriteriaRequest | 
apiInstance.qualityCriteriaUpdate(id, qualityCriteriaRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
