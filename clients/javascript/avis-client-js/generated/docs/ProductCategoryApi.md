...
apiInstance.productCategoryCreate(productCategoryRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let id = 56; // Number | A unique integer value identifying this product category.
let opts = {
  'patchedProductCategoryRequest': new ViunAvisClientJs.PatchedProductCategoryRequest() // PatchedProductCategoryRequest | 
};
...
let id = 56; // Number | A unique integer value identifying this product category.
let productCategoryRequest = new ViunAvisClientJs.ProductCategoryRequest(); // ProductCategoryRequest | 
apiInstance.productCategoryUpdate(id, productCategoryRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
