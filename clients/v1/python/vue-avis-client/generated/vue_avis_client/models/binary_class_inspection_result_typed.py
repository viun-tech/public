...
class BinaryClassInspectionResultTyped(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "team", "reported_by", "image", "type", "created_at", "updated_at", "confidence", "comment", "binary_class"]
