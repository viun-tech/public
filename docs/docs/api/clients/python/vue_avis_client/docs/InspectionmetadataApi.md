# vue_avis_client.InspectionmetadataApi
...
with vue_avis_client.ApiClient(configuration) as api_client:
    ...
    api_instance = vue_avis_client.InspectionmetadataApi(api_client)
    inspection_metadata_request = vue_avis_client.InspectionMetadataRequest() # InspectionMetadataRequest |
...
> List[InspectionMetadata] inspectionmetadata_list(id=id)
...
with vue_avis_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.inspectionmetadata_list(id=id)
...
with vue_avis_client.ApiClient(configuration) as api_client:
    ...
    api_instance = vue_avis_client.InspectionmetadataApi(api_client)
    id = 56 # int | A unique integer value identifying this inspection metadata.
    patched_inspection_metadata_request = vue_avis_client.PatchedInspectionMetadataRequest() # PatchedInspectionMetadataRequest |  (optional)
...
> InspectionMetadata inspectionmetadata_retrieve(id)
...
with vue_avis_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.inspectionmetadata_retrieve(id)
